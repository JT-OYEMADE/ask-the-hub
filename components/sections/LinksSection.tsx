      ...
      <div className="px-5 py-5 flex flex-col gap-2">
        {links.map((link, i) => (
          <a
            ...
            className="flex items-center gap-3 px-4 py-3.5 rounded-[10px] border cursor-pointer transition-colors hover:border-[rgba(212,255,92,0.2)] hover:bg-[rgba(212,255,92,0.03)]"
            style={{
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="text-[0.87rem] font-medium text-white truncate">
                {link.title}
              </div>
